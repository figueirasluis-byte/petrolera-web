        ...
        <form onSubmit={handleSubmit} className="rounded-2xl p-8 flex flex-col gap-5"
          ...
          <div>
            ...
            <select name="servicio" required
              ...
              style={{background: 'rgba(30,60,40,0.9)', border: '1px solid rgba(34,197,94,0.2)', color: 'rgba(255,255,255,0.7)'}}>
          ...
          <button type="submit"
            className="w-full text-white font-bold py-4 rounded-xl transition-all mt-2 text-base"
